...
<div class="container">
	...
	<?php
		...
		$img = mysqli_query($db,"select count(MaCongViec) as sf from congviec where TinhChatCongViec=0");
		...
		congviec.YeuCauCongViec, congviec.SoLuongCongViec, congty.DiaChiCongTy, congviec.MucLuongCongViec from congty,congviec where congty.MaCongTy = congviec.MaCongTy && congviec.TinhChatCongViec=0");					
	...
	<h2 class="TimViec_title" ><?php echo $row['sf'];?> Công Việc Part Chất Lượng cho bạn</h2>
			<?php		
