...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 14, 2018 at 07:04 PM
...
(3, 'VietinBank', '/images/congty3.png', '/images/anhcongty3.png', 'Ba Đình, Hà Nội', 'Thứ 2 - 7', 'Được Đóng Bảo Hiểm, Tham gia các khóa học nâng cao', 2),
...
(10, 'Fujinet', '/images/congty7.png', '/images/anhcongty7.png', 'Quân 8, Tp Hồ Chí Minh', 'Thứ 2-6', 'Được tham đi tham quan, du lịch', 2);
...
(5, 'Nhân Viên TesTer', '-ffasdfas', 'từ 20 - 25 triệu', 'vzvzc', 1, 3, '/images/anhcongviec2.png', 1, 2),
(6, 'lập trình viên php', '-làm việc với ngôn ngữ php\r\n- lập trình website', '15-20 triệu', ' - 2 năm kinh nghiệm lập trình php\r\n - đọc hiểu tiếng anh\r\n - khả năng làm việc nhóm', 1, 2, '/images/anhcongviec2.png', 1, 2),
...
(18, 'duc', 'duc', '3 triệu', 'duc', 1, 1, '/images/download (1).jpg', 1, 1),
(19, 'hieu', 'hieu', '1 tieu', 'hieu                          ', 0, 1, '/images/download (2).jpg', 4, 1),
...
(2, 'hieu', '202cb962ac59075b964b07152d234b70'),
(3, 'hai', '202cb962ac59075b964b07152d234b70'),
(11, 'duc', '202cb962ac59075b964b07152d234b70'),
(14, 'hung', '202cb962ac59075b964b07152d234b70'),
...
--
ALTER TABLE `congty`
  MODIFY `MaCongTy` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
--
-- AUTO_INCREMENT for table `congviec`
--
ALTER TABLE `congviec`
  MODIFY `MaCongViec` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=25;
--
-- AUTO_INCREMENT for table `nguoixinviec`
--
ALTER TABLE `nguoixinviec`
  MODIFY `MaNguoiXinViec` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;
--
-- AUTO_INCREMENT for table `user`
--
ALTER TABLE `user`
  MODIFY `MaUser` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
